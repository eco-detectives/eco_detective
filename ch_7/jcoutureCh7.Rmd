...
for(i in 1:length(Ks)){
  nllDF[,i+1]<-apply(nllArr[,,i],2, sum)
}

minDims<-which(nllDF==min(nllDF),arr.ind=T)

nll_r=nllDF[minDims[1],1]
nll_k=colnames(nllDF)[13]

plot(K1400~r,data=nllDF,type="l",main="K=1400",ylab="NLL")
```
